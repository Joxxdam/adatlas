...
function runCollector() {
  const child = spawn(process.execPath, ["scripts/daily-collector.mjs"], {
    cwd: process.cwd(),
    env: process.env,
    stdio: "inherit",
  });
...
function schedule() {
  ...
  console.log(`Next AdAtlas collection: ${next.toISOString()} Asia/Seoul`);
  setTimeout(runCollector, delay);
}
