...
test("robots wildcards do not turn a partial path rule into a site-wide block", () => {
  ...
  assert.equal(robotsAllowsUrl(ririncoPolicy, "https://ririnco.com/product/list.html?cate_no=62"), true);
  assert.equal(robotsAllowsUrl(ririncoPolicy, "https://ririnco.com/board/product/list.html?board_no=4&page=2"), false);
});
...
test("robots wildcard and end-anchor semantics remain enforced", () => {
  ...
  assert.equal(robotsAllowsUrl(ririncoPolicy, "https://ririnco.com/skin-mobile/layout.html"), false);
