...
import { inferBackgroundCategory } from "../../../lib/background-library/recommender";
import {
...
export async function POST(request: Request) {
  try {
    ...
    const file = `/background-library/ai-generated/${id}.webp`;
    ...
    const item: BackgroundLibraryItem = {
      ...
      hookTypes: hook.hookType ? [hook.hookType] : ["feature-usp"],
      ...
      sourceUrl: `ai://${body.provider || "unknown"}`,
      licenseUrl: "",
      downloadedAt: now,
      enabled: true,
    };
