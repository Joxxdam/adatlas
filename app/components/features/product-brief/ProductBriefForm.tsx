...
const intensityDescriptions: Record<AdBrief["creativeIntensity"], string> = {
  brand: "할인보다 상품과 브랜드 이미지를 깔끔하게 전달합니다.",
  balanced: "브랜드 이미지와 구매 혜택을 함께 전달합니다.",
  performance: "가격, 할인, 구성 등 구매 이유를 강하게 강조합니다.",
};
    ...
    <section className={styles.section}>
      ...
      <div className={styles.formGrid}>
        ...
        <label>
          ...
          >
            <option value="brand">브랜드형</option>
            <option value="balanced">균형형</option>
            <option value="performance">강전환형</option>
          </select>
          <small>{intensityDescriptions[props.brief.creativeIntensity]}</small>
        </label>
