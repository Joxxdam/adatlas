...
export function SceneCandidateCard(props: {
  ...
  return (
    <button
      ...
      className={`${styles.candidate} ${props.selected ? styles.selected : ""}`}
    ...
    >
      ...
      <div className={styles.candidateMeta}>
        ...
        {props.candidate.quality ? (
          <small
            className={`${styles.qualityBadge} ${styles[props.candidate.quality.status]}`}
            title={props.candidate.quality.reasons.join(" ") || "기술 품질 검사를 통과했습니다."}
          >
